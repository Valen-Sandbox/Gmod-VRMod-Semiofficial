...
AddCSLuaFile()
CreateClientConVar("vrmod_pickup_beamrange02", 11, true, FCVAR_ARCHIVE, "Range to check for entities to grab")
...
local beamrange = CreateClientConVar("vrmod_pickup_beamrange", 1000, true, FCVAR_ARCHIVE, "Range to check for beam")
